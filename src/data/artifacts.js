...
export const series = [
  ...
  },
  {
    ...
    episodes: [
      ...
      {
        language: 'PL',
        title: 'Across Stack - #2 Python & Flask',
        type: 'webinar',
        url:
      ...
      {
        language: 'PL',
        title: 'Across Stack - #1 C# & Asp.net',
        type: 'webinar',
        url:
...
export const articles = [
  {
    language: 'PL',
    title: 'ngPoland 2017 — Takeaways – codeburst',
    url: 'https://codeburst.io/ngpoland-2017-takeaways-a7d455363106',
    thumbnailUrl: '',
    description:
      'I was co-hosting, as technical guest, live-stream audition with Jakub Jurkiewicz from New Zeland',
    date: new Date('2017-05'),
